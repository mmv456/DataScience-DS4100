...
# create a function to load the dataframe
loadDF <- function() {
...
# We will have to delete the records that have NA in its Season1Date column.
...
# create columns to split the dates
threeColumns <- as.data.frame(str_split_fixed(farmersmarkets$Season1Date, " ", n=3)) # split into 3 columns


# So if we have "MM/DD/YY to MM/DD/YY", we will split it into 3 columns that separate it into 
# "MM/DD/YY", "to", and "MM/DD/YY"
...
# Function to determine what season the sates are within
# Args: Date in the format MM/DD/YY
# Returns: The season
...
# Function that creates a dataframe based on which markets accept WIC
